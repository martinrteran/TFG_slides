...
%% CONCLUSIONES
	...
	\only<8->{
		...
		\begin{itemize}
			...
			\item<10-> Sistemas multi-capa en emisor y uso de células multi-uniones.
			\item<11-> Diseñar una app para cálculos de rad. de campo cercano de sistemas multi-capa.			
		\end{itemize}
	}
	\end{frame}
